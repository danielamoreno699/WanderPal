...
RSpec.describe 'Api::V1::ItemsController', type: :request do
  describe 'GET /api/v1/items' do
    it 'returns a list of items' do
      create_list(:item, 3) # Assuming you're using FactoryBot for item creation
      get '/api/v1/items'
  ...
  describe 'GET /api/v1/items/:id' do
    it 'returns a single item' do
      item = create(:item) # Assuming you're using FactoryBot for item creation
  ...
  describe 'POST /api/v1/items' do
    it 'creates a new item' do
      user = create(:user) # Create a valid user
